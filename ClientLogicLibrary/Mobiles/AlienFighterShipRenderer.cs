...
{
	public class AlienFighterShipRenderer : ShipRenderer
	{
		...
		public AlienFighterShipRenderer(ShipPilot serverPilot)
			: base (serverPilot)
		{
			//Ship sprite
			shipSprite = new AnimatedSprite(_ServerPilot.WorldLocation, _ServerPilot.Size, TaticalScreenTextureManager.GetTexture("ship_alien_fighter"), new Rectangle(0, 0, 24, 16), "default", 1, 1.0f);
