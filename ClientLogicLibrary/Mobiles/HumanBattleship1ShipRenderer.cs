...
{
	public class HumanBattleship1ShipRenderer : ShipRenderer
	{
		public HumanBattleship1ShipRenderer(ShipPilot serverPilot)
			: base (serverPilot)
		{
			//Ship sprite
			shipSprite = new AnimatedSprite(_ServerPilot.WorldLocation, _ServerPilot.Size, TaticalScreenTextureManager.GetTexture("ship_human_battleship_1"), new Rectangle(0, 0, 123, 123), "default", 1, 1.0f);
		...
		private Vector2 engine1RelativeEmitterLocation = new Vector2(43, 44);
		...
		private Vector2 engine2RelativeEmitterLocation = new Vector2(43, 78);
