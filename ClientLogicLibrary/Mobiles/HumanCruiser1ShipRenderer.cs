...
{
	public class HumanCruiser1ShipRenderer : ShipRenderer
	{
		public HumanCruiser1ShipRenderer(ShipPilot serverPilot)
			: base (serverPilot)
		{
			//Ship sprite
			shipSprite = new AnimatedSprite(_ServerPilot.WorldLocation, _ServerPilot.Size, TaticalScreenTextureManager.GetTexture("ship_human_cruiser_1"), new Rectangle(0, 0, 64, 63), "default", 1, 1.0f);
		...
		private Vector2 engine1RelativeEmitterLocation = new Vector2(30, 6);
		...
		private Vector2 engine2RelativeEmitterLocation = new Vector2(30, 56);
